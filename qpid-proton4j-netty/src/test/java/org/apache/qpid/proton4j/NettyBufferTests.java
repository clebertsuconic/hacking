...
public class NettyBufferTests {
   ...
   public void testInvestigate() throws Exception {
      ...
      investigate( "");
      investigate( "0000006602000001005312d0000000560000000ab100000042717069642d6a6d733a73656e6465723a49443a65633534633037342d366633372d343733342d626635382d3530396332336532353430393a313a313a313a746573744341500250004040404243");

   }

   private void investigate(String investigate) throws IOException {
      byte[] investigateFrame = StringUtil.decodeHexDump(investigate);
      AMQPHandler handler = new AMQPSampleHandler(null, Integer.MAX_VALUE);
      ProtonBuffer buffer = new ProtonByteBuffer(investigateFrame);
      handler.readFrame(buffer);

      System.out.println("Current performative::" + handler.getCurrentPerformative());
   }
