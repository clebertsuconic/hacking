...
public final class EmptyProcessor implements Processor {

   private static final EmptyProcessor processor = new EmptyProcessor();

   public static EmptyProcessor get() {
      return processor;
   }
